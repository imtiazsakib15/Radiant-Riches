...
const Header = () => {
  return (
    <Container>
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl pt-4 text-[#2C384A]">
        Best Website builders in the US
      </h1>
      <div className="flex items-center justify-between flex-col sm:flex-row gap-4 py-3 border-y mt-5 text-sm text-[#4B5665]">
      ...
      <div className="flex gap-4 flex-wrap mt-6 text-sm text-[#4B5665]">
      ...
      <div className="hidden sm:block space-x-4 mt-3 text-sm text-[#5C6874]">
        <span>Home</span>
        <span>{">"}</span>
